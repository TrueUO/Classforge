    ...
    public static class Core
    {
        ...
        public static void Setup(IEnumerable<string> args)
        {
            ...
            foreach (string a in args)
            {
                ...
                {
                    Console.WriteLine("An Ultima Online server emulator written in C# - Visit https://github.com/TrueUO/Classforge for more information.\n\n");
                    Console.WriteLine(AppDomain.CurrentDomain.FriendlyName + " [Parameter]\n\n");
                    Console.WriteLine("     -debug              Starting Classforge in Debug Mode. Debug Mode is being used in Core and Scripts to give extended information during runtime.");
                    Console.WriteLine("     -haltonwarning      Classforge halts if any warning is raised during compilation of scripts.");
                    ...
                    Console.WriteLine("     -service            This parameter should be set if you're running Classforge as a Windows Service. No user interaction. *Windows only*");
...
#if DEBUG
            Console.WriteLine(
                "Classforge - [https://github.com/TrueUO/Classforge] Version {0}.{1}, Build {2}.{3} - Build on {4} UTC - Debug",
                ver.Major,
                ver.Minor,
                ver.Build,
                ver.Revision,
...
#else
			Console.WriteLine(
				"Classforge - [https://github.com/TrueUO/Classforge] Version {0}.{1}, Build {2}.{3} - Build on {4} UTC - Release",
				ver.Major,
				ver.Minor,
				ver.Build,
				ver.Revision,
