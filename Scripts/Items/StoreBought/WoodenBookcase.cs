            ...
            set
            {
                ...
                if (!IsEmpty && (id == 0x0A9D || id == 0x0A9E))
                {
                    switch (id)
                    {
                        case 0x0A9D:
                        {
                            base.ItemID = Utility.RandomList(0x0A97, 0x0A98, 0x0A9B); break;
                        }
                        case 0x0A9E:
                        {
                            base.ItemID = Utility.RandomList(0x0A99, 0x0A9A, 0x0A9C); break;
                        }
                    }
                }
                else if (IsEmpty && id != 0x0A9D && id != 0x0A9E)
                {
                    switch (id)
                    {
                        ...
                        case 0x0A9B:
                        {
                            base.ItemID = 0x0A9D; break;
                        }
                        case 0x0A99:
                        case 0x0A9A:
                        case 0x0A9C:
                        {
                            base.ItemID = 0x0A9E; break;
                        }
                    }
                }
                else
        ...
        public override void OnItemAdded(Item item)
        {
            ...
            if (ItemID == 0x0A9D || ItemID == 0x0A9E)
            {
                switch (ItemID)
                {
                    ...
                    case 0x0A9D:
                    {
                        ItemID = Utility.RandomList(0x0A97, 0x0A98, 0x0A9B); break;
                    }
                    case 0x0A9E:
                    {
                        ItemID = Utility.RandomList(0x0A99, 0x0A9A, 0x0A9C); break;
                    }
                }
            }
        }
