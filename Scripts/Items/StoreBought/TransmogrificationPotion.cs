        ...
        public class BaseTransmogrificationPotionGump : Gump
        {
            ...
            private class InternalTarget : Target
            {
                ...
                protected override void OnTarget(Mobile from, object targeted)
                {
                    ...
                    ItemProps ip = new ItemProps { Item = targetitem, Props = Mannequin.FindMagicalItemProperty(targetitem) };
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                switch (info.ButtonID)
                {
                    ...
                    case 1:
                    {
                        ...
                        Transmogrified socket = Potion.Source.Item.GetSocket<Transmogrified>();
