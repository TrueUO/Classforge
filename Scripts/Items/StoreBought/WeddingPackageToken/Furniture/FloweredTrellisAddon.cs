...
namespace Server.Items
{
    ...
    public class FloweredTrellisAddon : BaseAddon
    {
        ...
        public FloweredTrellisAddon(TrellisType type, bool south)
        {
            ...
            {
                default:
                case TrellisType.Leafy:
                {
                    list = south ? _LeafySouth : _LeafyEast; break;
                }
                case TrellisType.Rose:
                {
                    list = south ? _RoseSouth : _RoseEast; break;
                }
                case TrellisType.Bigflow:
                {
                    list = south ? _BigflowSouth : _BigflowEast; break;
                }
            }
