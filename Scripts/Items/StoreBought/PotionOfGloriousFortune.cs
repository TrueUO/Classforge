...
namespace Server.Items
{
    ...
    public class PotionOfGloriousFortune : Item
    {
        ...
        public static void OnTick()
        {
            ...
            List<PotionArray> list = new List<PotionArray>(Table);

            foreach (PotionArray l in list)
            {
        ...
        public static bool UnderEffects(Mobile m, PotionEventType type)
        {
            if (Table != null)
            {
                PotionArray list = Table.FirstOrDefault(x => x.Mobile == m && x.Type == type);
            ...
            Persistence.Deserialize(
                ...
                reader =>
                {
                    ...
                    for (int i = count; i > 0; i--)
                    {
                        ...
                        PotionEventType et = (PotionEventType)reader.ReadInt();
        ...
        public static void OnLogin(Mobile m)
        {
            ...
            {
                PotionArray list = Table.FirstOrDefault(x => x.Mobile == pm);
