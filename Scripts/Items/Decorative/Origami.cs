        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                switch (Utility.Random((from.BAC >= 7) ? 8 : 7)) //switch ( Utility.Random( (from.BAC >= 5) ? 6 : 5) )
                {
                    case 0:
                    {
                        i = new OrigamiButterfly(); break;
                    }
                    case 1:
                    {
                        i = new OrigamiSwan(); break;
                    }
                    case 2:
                    {
                        i = new OrigamiFrog(); break;
                    }
                    case 3:
                    {
                        i = new OrigamiShape(); break;
                    }
                    case 4:
                    {
                        i = new OrigamiSongbird(); break;
                    }
                    case 5:
                    {
                        i = new OrigamiFish(); break;
                    }
                    case 6:
                    {
                        i = new OrigamiDragon(); break;
                    }
                    case 7:
                    {
                        i = new OrigamiBunny(); break;
                    }
                }
