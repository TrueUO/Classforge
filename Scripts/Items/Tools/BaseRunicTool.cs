        ...
        public static void ApplyAttributesTo(FishingPole pole, bool playerMade, int luckChance, int attributeCount, int min, int max)
        {
            ...
            for (int i = 0; i < attributeCount; ++i)
            {
                ...
                switch (random)
                {
                    ...
                    case 1:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.CastSpeed, 1, 1); break;
                    }
                    case 2:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.CastRecovery, 1, 1); break;
                    }
                    case 3:
                    {
                    ...
                    case 4:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.Luck, 1, 100); break;
                    }
                    case 5:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.SpellChanneling, 1, 1); break;
                    }
                    case 6:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.RegenHits, 1, 2); break;
                    }
                    case 7:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.RegenMana, 1, 2); break;
                    }
                    case 8:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.RegenStam, 1, 3); break;
                    }
                    case 9:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.BonusHits, 1, 8); break;
                    }
                    case 10:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.BonusMana, 1, 8); break;
                    }
                    case 11:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.BonusStam, 1, 8); break;
                    }
                    case 12:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.BonusStr, 1, 8); break;
                    }
                    case 13:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.BonusDex, 1, 8); break;
                    }
                    case 14:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.BonusInt, 1, 8); break;
                    }
                    case 15:
                    {
                        ApplyAttribute(primary, min, max, AosAttribute.SpellDamage, 1, 12); break;
                    }
                    case 16:
                    {
        ...
        private static void ApplySkillBonus(AosSkillBonuses attrs, int min, int max, int index, int low, int high)
        {
            ...
            if (attrs.Owner is Spellbook book)
            {
                ...
                switch (book.SpellbookType)
                {
                    ...
                    {
                        booktypeskills = new SkillName[] { SkillName.Magery }; break;
                    }
                    case SpellbookType.Necromancer:
                    {
                        booktypeskills = new SkillName[] { SkillName.Necromancy, SkillName.SpiritSpeak }; break;
                    }
                    case SpellbookType.Mystic:
                    {
                        booktypeskills = new SkillName[] { SkillName.Mysticism, SkillName.Focus }; break;
                    }
                }

                List<SkillName> list = new List<SkillName>();

                foreach (SkillName name in m_PossibleSpellbookSkills.Concat(booktypeskills))
                {
                    list.Add(name);
                }
