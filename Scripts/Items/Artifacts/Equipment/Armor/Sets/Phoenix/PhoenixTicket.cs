        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                switch (Utility.Random(6))
                {
                    case 0:
                    {
                        from.AddToBackpack(new PhoenixArms()); break;
                    }
                    case 1:
                    {
                        from.AddToBackpack(new PhoenixChest()); break;
                    }
                    case 2:
                    {
                        from.AddToBackpack(new PhoenixGloves()); break;
                    }
                    case 3:
                    {
                        from.AddToBackpack(new PhoenixGorget()); break;
                    }
                    case 4:
                    {
                        from.AddToBackpack(new PhoenixHelm()); break;
                    }
                    case 5:
                    {
                        from.AddToBackpack(new PhoenixLegs()); break;
                    }
                }
                Delete();
