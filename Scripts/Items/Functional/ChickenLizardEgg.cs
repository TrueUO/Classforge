    ...
    public class ChickenLizardEgg : Item
    {
                ...
                if (IncubationStart != DateTime.MinValue)
                {
                    ...
                    else
                    {
                        switch (Dryness)
                        {
                            case Dryness.Moist:
                            {
                                c = 1112462; break; // a moist egg
                            }
                            case Dryness.Dry:
                            {
                                c = 1112463; break; // a dry egg
                            }
                            case Dryness.Parched:
                            {
                                c = 1112464; break; // a parched egg
                            }
                            case Dryness.Dehydrated:
                            {
                                c = 1112465; break; // a dehydrated egg
                            }
                        }
                    }
                }
        ...
        private int GetRandomBattleChickenLizardHue()
        {
            switch (Utility.Random(20))
            {
                case 0:
                {
                    return 660;     // Green hue
                }
                case 1:
                {
                    return 60;      // Light Green hue
                }
                case 2:
                {
                    return 2001;    // Dark Green hue
                }
                case 3:
                {
                    return 1372;    // Strong Green hue
                }
                case 4:
                {
                    return 71;      // Dryad Green hue
                }
                case 5:
                {
                    return 678;     // Nox Green hue
                }
                case 6:
                {
                    return 291;     // Ice Green hue
                }
                case 7:
                {
                    return 1151;    // Cyan hue
                }
                case 8:
                {
                    return 691;     // Valorite hue
                }
                case 9:
                {
                    return 1154;    // Ice Blue hue
                }
                case 10:
                {
                    return 1165;   // Light Blue hue
                }
                case 11:
                {
                    return 1173;   // Strong Cyan hue
                }
                case 12:
                {
                    return 1301;   // Midnight Blue hue
                }
                case 13:
                {
                    return 1159;   // Blue & Yellow hue
                }
                case 14:
                {
                    return 55;     // Strong Yellow hue
                }
                case 15:
                {
                    return 50;     // Gold hue
                ...
                case 18:
                {
                    return 1168;   // Strong Purple hue
                }
                case 19:
                {
                    return 1105;   // Black hue
                }
            }
