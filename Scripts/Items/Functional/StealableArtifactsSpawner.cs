...
namespace Server.Items
{
    public class StealableArtifactsSpawner : Item
    {
        ...
        {            
            ...
            new StealableEntry(Map.Malas, new Point3D(354, 36, -1), 9216, 13824, typeof(SkinnedDeerArtifact)), new StealableEntry(Map.Malas, new Point3D(274, 231, 0), 9216, 13824, typeof(HangingPlatemailTunic)),
            ...
            new StealableEntry(Map.Malas, new Point3D(403, 31, 4), 18432, 27648, typeof(LeatherTunicArtifact)), new StealableEntry(Map.Malas, new Point3D(378, 371, -1), 18432, 27648, typeof(ArtifactBookshelf)),
            ...
            new StealableEntry(Map.Malas, new Point3D(487, 364, -1), 147456, 221184, typeof(RuinedPaintingArtifact)), new StealableEntry(Map.Malas, new Point3D(263, 28, 0), 147456, 221184, typeof(IncenseBurner)),
        ...
        private static void StealArtiesForceRespawn_OnCommand(CommandEventArgs e)
        {
            ...
            {
                for (int index = 0; index < Instance.m_Artifacts.Length; index++)
                {
        ...
        public override void OnDelete()
        {
            ...
            for (int index = 0; index < m_Artifacts.Length; index++)
            {
