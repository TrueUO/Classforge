    ...
    public class Auction : IDisposable
    {
        ...
        public bool TryPlaceBid(Mobile m, long bidTotal)
        {
            ...
            else
            {
                ...
                PlayerMobile mobile = HighestBid != null ? HighestBid.Mobile : null;
        ...
        public void EndAuction(bool buyout)
        {
            ...
            {
                bool isPublic = PublicAuction;
                PlayerMobile m = HighestBid.Mobile;
                string name = AuctionItemName();
        ...
        private void CloseGumps()
        {
            if (Viewers != null)
            {
                for (int index = 0; index < Viewers.Count; index++)
                {
                    PlayerMobile pm = Viewers[index];
        ...
        public static void Initialize()
        {
            ...
            {
                for (int index = 0; index < Auctions.Count; index++)
                {
                    Auction a = Auctions[index];
