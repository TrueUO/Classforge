    ...
    public class SliderTrapGump : BaseGump
    {
        ...
        private bool ValidMove(int pick, int empty)
        {
            switch (pick)
            {
                case 0:
                {
                    return empty == 1 || empty == 3;
                }
                case 1:
                {
                    return empty == 0 || empty == 2 || empty == 4;
                }
                case 2:
                {
                    return empty == 1 || empty == 5;
                }
                case 3:
                {
                    return empty == 0 || empty == 4 || empty == 6;
                }
                case 4:
                {
                    return empty == 1 || empty == 3 || empty == 5 || empty == 7;
                }
                case 5:
                {
                    return empty == 2 || empty == 4 || empty == 8;
                }
                case 6:
                {
                    return empty == 3 || empty == 7;
                }
                case 7:
                {
                    return empty == 4 || empty == 6 || empty == 8;
                }
                case 8:
                {
                    return empty == 5 || empty == 7;
                }
            }
