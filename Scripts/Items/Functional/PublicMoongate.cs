...
namespace Server.Items
{
    public class PublicMoongate : Item
    {
        ...
        {
            for (int index = 0; index < list.Entries.Length; index++)
            {
    ...
    public class PMList
    {
        ...
        public static readonly PMList[] Lists = [Trammel, Felucca, Ilshenar, Malas];
        public static readonly PMList[] RedLists = [Felucca];
        public static readonly PMList[] SigilLists = [Felucca];

        public static readonly PMList[] AllLists = [Trammel, Felucca, Ilshenar, Malas];
        ...
        public static int IndexOfEntry(PMEntry entry)
        {
            ...
            {
                PMList o = AllLists[index];

                bool contains = false;

                for (int i = 0; i < o.Entries.Length; i++)
                {
                    PMEntry oEntry = o.Entries[i];
    ...
    public class MoongateGump : Gump
    {
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            else if (m_Mobile.Player && SpellHelper.RestrictRedTravel && m_Mobile.Murderer && map != Map.Felucca)
            {
