...
namespace Server.Engines.VeteranRewards
{
    ...
    {
        public override BaseAddonDeed Deed => new GadgetryTableAddonDeed();
                ...
                if (house != null)
                {
                    if (CheckAccessible(from, this))
                    {
                        ...
                        else
                        {
                            ...
                            for (int index = 0; index < ((PlayerMobile) from).AllFollowers.Count; index++)
                            {
                                Mobile x = ((PlayerMobile) from).AllFollowers[index];
                            ...
                            else
                            {
                                ...
                                for (int index = 0; index < from.Stabled.Count; index++)
                                {
                                    Mobile x = from.Stabled[index];
    ...
    public class GadgetryTableAddonDeed : BaseAddonDeed, IRewardOption
    {
        ...
        public override BaseAddon Addon => new GadgetryTableAddon(_Direction);
    ...
    public class GadgetryTableGolem : Golem
    {
        [Constructable]
