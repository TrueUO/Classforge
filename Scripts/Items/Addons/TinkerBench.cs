...
namespace Server.Items
{
    public class TinkerBenchAddon : CraftAddon
    {
        ...
        public override BaseAddonDeed Deed => new TinkerBenchDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0);
    ...
    public class TinkerBenchDeed : CraftAddonDeed, IRewardOption
    {
        ...
        public override BaseAddon Addon => new TinkerBenchAddon(_Direction, UsesRemaining);
