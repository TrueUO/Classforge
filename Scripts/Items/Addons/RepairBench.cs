...
namespace Server.Items
{
    ...
    public class RepairBenchAddon : BaseAddon, ISecurable
    {
        ...
        public static RepairBenchDefinition GetInfo(RepairSkillType type)
        {
            ...
            {
                RepairBenchDefinition definition = Definitions[index];
        ...
        public RepairBenchAddon(DirectionType type, List<RepairBenchDefinition> tools)
        {
            ...
            if (tools == null)
            {
                ...
                for (int index = 0; index < Definitions.ToList().Count; index++)
                {
                    RepairBenchDefinition x = Definitions.ToList()[index];
        ...
        public override BaseAddonDeed Deed => new RepairBenchDeed(Tools);
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            if (Tools != null)
            {
                ...
                {
                    RepairBenchDefinition x = Tools[index];
    ...
    public class RepairBenchDeed : BaseAddonDeed, IRewardOption
    {
        ...
        public override BaseAddon Addon => new RepairBenchAddon(_Direction, Tools);
