...
namespace Server.Items
{
    public class GlassKilnAddon : CraftAddon
    {
        ...
        public override BaseAddonDeed Deed => new GlassKilnDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0);
    ...
    public class GlassKilnDeed : CraftAddonDeed, IRewardOption
    {
        ...
        public override BaseAddon Addon => new GlassKilnAddon(_Direction, UsesRemaining);
