...
namespace Server.Items
{
    ...
    public class RoseRugAddon : BaseAddon
    {
        ...
        public override BaseAddonDeed Deed => new RoseRugAddonDeed(RugType, m_ResourceCount, NextResourceCount);
    ...
    {
        public override BaseAddon Addon => new RoseRugAddon(RugType, m_ResourceCount, NextResourceCount);
