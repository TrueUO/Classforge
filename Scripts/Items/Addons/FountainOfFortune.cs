...
namespace Server.Items
{
    public class FountainOfFortune : BaseAddon
    {
        ...
        public bool OnTarget(Mobile from, Item coin)
        {
            ...
            if (.20 >= Utility.RandomDouble())
            {
                ...
                switch (Utility.Random(4))
                {
                    ...
                    case 0:
                    {
                        item = new SolesOfProvidence(); break;
                    }
                    case 1:
                    {
                        item = new GemologistsSatchel(); break;
                    }
                    case 2:
                    {
                        item = new RelicFragment(5); break;
                    }
                    case 3:
                    {
                        item = new EnchantedEssence(5); break;
                    }
                }
        ...
        {
            for (int index = 0; index < m_Fountains.Count; index++)
            {
