...
namespace Server.Items
{
    public class DolphinRugAddon : BaseAddon
    {
        ...
        public override BaseAddonDeed Deed => new DolphinRugAddonDeed(RugType, m_ResourceCount, NextResourceCount);
    ...
    {
        public override BaseAddon Addon => new DolphinRugAddon(RugType, m_ResourceCount, NextResourceCount);
