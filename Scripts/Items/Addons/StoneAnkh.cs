...
namespace Server.Items
{
    ...
    public class StoneAnkh : BaseAddon
    {
        ...
        public override BaseAddonDeed Deed => new StoneAnkhDeed();
        ...
        public override void OnComponentUsed(AddonComponent c, Mobile from)
        {
            if (from.InRange(Location, 2))
            {
                ...
                {
                    from.CloseGump(typeof(DecorationReDeedGump));
                    from.SendGump(new DecorationReDeedGump(this, 1049783)); // Do you wish to re-deed this decoration?
                }
                else
                {
    ...
    public class StoneAnkhDeed : BaseAddonDeed
    {
        ...
        public override BaseAddon Addon => new StoneAnkh(m_East);
