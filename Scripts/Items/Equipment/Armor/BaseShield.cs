...
namespace Server.Items
{
    ...
    {
        public override CharacterClass ClassRequired => CharacterClass.Warrior;
            ...
            else
            {
                ...
                else
                {
                    switch (Utility.Random(7))
                    {
                        case 0:
                        {
                            Attributes.BonusDex += attrInfo.ShieldBonusDex; break;
                        }
                        case 1:
                        {
                            Attributes.BonusStr += attrInfo.ShieldBonusStr; break;
                        }
                        case 2:
                        {
                            PhysicalBonus += attrInfo.ShieldPhysicalRandom; break;
                        }
                        case 3:
                        {
                            Attributes.ReflectPhysical += attrInfo.ShieldReflectPhys; break;
                        }
                        case 4:
                        {
                            ArmorAttributes.SelfRepair += attrInfo.ShieldSelfRepair; break;
                        }
                        case 5:
                        {
                            ColdBonus += attrInfo.ShieldColdRandom; break;
                        }
                        case 6:
                        {
                            Attributes.SpellChanneling += attrInfo.ShieldSpellChanneling; break;
                        }
                    }
                }
