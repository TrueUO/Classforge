        ...
        public void DistributeBonuses(Mobile from, int amount)
        {
            for (int i = 0; i < amount; ++i)
            {
                switch (Utility.Random(5))
                {
                    case 0:
                    {
                        ++m_AosResistances.Physical; break;
                    }
                    case 1:
                    {
                        ++m_AosResistances.Fire; break;
                    }
                    case 2:
                    {
                        ++m_AosResistances.Cold; break;
                    }
                    case 3:
                    {
                        ++m_AosResistances.Poison; break;
                    }
                    case 4:
                    {
                        ++m_AosResistances.Energy; break;
                    }
                }
            }
            ...
            if (from != null)
            {
                int bonus = (int)Math.Min(4, from.Skills.ArmsLore.Value / 20);
                ...
                for (int i = 0; i < bonus; i++)
                {
                    switch (Utility.Random(5))
                    {
                        case 0:
                        {
                            Resistances.Physical++; break;
                        }
                        case 1:
                        {
                            Resistances.Fire++; break;
                        }
                        case 2:
                        {
                            Resistances.Cold++; break;
                        }
                        case 3:
                        {
                            Resistances.Poison++; break;
                        }
                        case 4:
                        {
                            Resistances.Energy++; break;
                        }
                    }
                }
