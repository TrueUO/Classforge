    ...
    public class ManaPhasingOrb : BaseTalisman, Engines.Craft.IRepairable
    {
        ...
        public ManaPhasingOrb() : base(4246)
        {
            ...
            switch (Utility.Random(3))
            {
                case 0:
                {
                    Attributes.RegenHits = 1; break;
                }
                case 1:
                {
                    Attributes.RegenMana = 1; break;
                }
                case 2:
                {
                    Attributes.RegenStam = 1; break;
                }
            }
            ...
            switch (Utility.Random(3))
            {
                case 0:
                {
                    Attributes.LowerRegCost = 10; break;
                }
                case 1:
                {
                    Attributes.WeaponDamage = 15; break;
                }
                case 2:
                {
                    Attributes.SpellDamage = 5; break;
                }
            }
        }
