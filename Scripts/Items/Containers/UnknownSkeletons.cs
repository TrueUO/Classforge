    ...
    public class UnknownBardSkeleton : BaseContainer
    {
            ...
            : base(0xECA + Utility.Random(9))
        {
            ...
            switch (Utility.Random(2))
            {
                case 0:
                {
                    DropItem(new Kilt(Utility.RandomNondyedHue())); break;
                }
                case 1:
                {
                    DropItem(new ShortPants(Utility.RandomNondyedHue())); break;
                }
            }
            ...
            switch (Utility.Random(3))
            {
                case 0:
                {
                    DropItem(new BeverageBottle(BeverageType.Ale)); break;
                }
                case 1:
                {
                    DropItem(new BeverageBottle(BeverageType.Wine)); break;
                }
                case 2:
                {
                    DropItem(new BeverageBottle(BeverageType.Liquor)); break;
                }
            }
