            ...
            : base(0xE80)
        {
            ...
            for (int i = 0; i < level * 5 + Utility.Random(5); i++)
            {
                switch (Utility.Random(8))
                {
                    case 0:
                    {
                        DropItemStacked(new BlueDiamond()); break;
                    }
                    case 1:
                    {
                        DropItemStacked(new FireRuby()); break;
                    }
                    case 2:
                    {
                        DropItemStacked(new BrilliantAmber()); break;
                    }
                    case 3:
                    {
                        DropItemStacked(new PerfectEmerald()); break;
                    }
                    case 4:
                    {
                        DropItemStacked(new DarkSapphire()); break;
                    }
                    case 5:
                    {
                        DropItemStacked(new Turquoise()); break;
                    }
                    case 6:
                    {
                        DropItemStacked(new EcruCitrine()); break;
                    }
                    case 7:
                    {
                        DropItemStacked(new WhitePearl()); break;
                    }
                }
            }
