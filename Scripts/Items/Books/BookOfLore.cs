    ...
    public class BookOfLore : Item, ISecurable
    {
        ...
        public class BookOfLoreGump : Gump
        {
                ...
                : base(100, 100)
            {
                ...
                IOrderedEnumerable<int> pages = book.Content.OrderBy(x => x);
                ...
                StoryDefinition content = PageOfLore.Table.FirstOrDefault(x => x.Story == book.Story && x.PageID == Page);
