        ...
        static SlayerGroup()
        {
            ...
            humanoid.Super = new SlayerEntry
                (
                    ...
                    typeof(Minotaur), typeof(MinotaurGeneral),
                    typeof(Medusa), typeof(EnslavedGoblinScout),
            ...
            eodonTribe.Super = new SlayerEntry(SlayerName.EodonTribe, typeof(Savage), typeof(SavageShaman)); // place holders, need to remove
