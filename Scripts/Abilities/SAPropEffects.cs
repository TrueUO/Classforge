...
namespace Server.Items
{
    ...
    public class PropertyEffect
    {
        ...
        public static bool VictimIsUnderEffects<T>(Mobile from)
        {
            ...
            {
                PropertyEffect e = Effects[index];
    ...
    public class DamageEaterContext : PropertyEffect
    {
        ...
        public static int GetValue(DamageType type, Mobile from)
        {
            ...
            switch (type)
            {
                ...
                {
                    return SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterKinetic);
                }
                case DamageType.Fire:
                {
                    return SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterFire);
                }
                case DamageType.Cold:
                {
                    return SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterCold);
                }
                case DamageType.Poison:
                {
                    return SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterPoison);
                }
                case DamageType.Energy:
                {
                    return SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterEnergy);
                }
                case DamageType.AllTypes:
                {
                    return SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterDamage);
                }
            }
