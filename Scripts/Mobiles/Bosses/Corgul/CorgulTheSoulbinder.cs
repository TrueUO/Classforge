...
namespace Server.Mobiles
{
    public class CorgulTheSoulBinder : BaseSeaChampion
    {
        ...
        public override Type[] UniqueList => [typeof(CorgulsEnchantedSash), typeof(CorgulsHandbookOnTheUndead)];
        public override Type[] SharedList => [];
        public override Type[] DecorativeList => [typeof(EnchantedBladeDeed), typeof(EnchantedVortexDeed)];
