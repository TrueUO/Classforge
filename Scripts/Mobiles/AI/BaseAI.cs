...
namespace Server.Mobiles
{
    ...
    public abstract class BaseAI
    {
        ...
        public virtual bool DoOrderGuard()
        {
            ...
            for (int index = 0; index < controlMaster.Aggressors.Count; index++)
            {
                AggressorInfo x = controlMaster.Aggressors[index];
            ...
            for (int index = 0; index < controlMaster.Aggressed.Count; index++)
            {
                AggressorInfo x = controlMaster.Aggressed[index];
