    ...
    public class UniqueTreasureBag : Pouch
    {
        ...
        public UniqueTreasureBag()
        {
            switch (Utility.Random(6))
            {
                case 0:
                {
                    DropItem(new LavaRockDisplay()); break;
                }
                case 1:
                {
                ...
                case 2:
                {
                    DropItem(new BananaHoardAddonDeed()); break;
                }
                case 3:
                {
                    DropItem(new DragonTurtleFountainAddonDeed()); break;
                }
                case 4:
                {
                    DropItem(new DinosaurHunterRewardTitleDeed()); break;
                }
                case 5:
                {
                    DropItem(new PetTigerCubStatuette()); break;
                }
            }
        }
