    ...
    public class Cleanup
    {
        ...
        public static void Run()
        {
            ...
            foreach (Item item in World.Items.Values)
            {
                ...
                {
                    for (int index = 0; index < house.RelocatedEntities.Count; index++)
                    {
                    ...
                    for (int index = 0; index < house.VendorInventories.Count; index++)
                    {
        ...
        public static bool IsBuggable(Item item)
        {
            ...
            if (item is ICommodity || item is BaseBoat ||
                ...
                item is Web || item is WaterTile || item is DirtPatch ||
                item is Futon)
            {
                return true;
            }
