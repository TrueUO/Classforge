    ...
    public class SpellHelper
    {
        ...
        private static bool IsExempt(SkillName main, SkillName secondary)
        {
            switch (main)
            {
                ...
                {
                    return secondary == SkillName.EvalInt;
                }
                case SkillName.Necromancy:
                {
                    return secondary == SkillName.SpiritSpeak;
                }
                case SkillName.Mysticism:
                {
                    return secondary == SkillName.Focus || secondary == SkillName.Imbuing;
                }
            }
        }
        ...
        public static bool ValidIndirectTarget(Mobile from, Mobile to)
        {
            ...
            BaseCreature toCreature = to as BaseCreature;

            if (toCreature != null && (toCreature.Controlled || toCreature.Summoned))
            {
                Mobile master = toCreature.GetMaster();
            ...
            if (fromCreature != null)
            {
                ...
                {
                    Mobile master = fromCreature.GetMaster();
        ...
        public static bool CheckReflect(Spell spell, ref IDamageable source, ref IDamageable defender)
        {
            ...
            if (spell.SpellDamageType == DamageType.Spell)
            {
                ...
                if (caster != null && target != null)
                {
                    ...
                    MagicReflectSpell.MagicReflectContext context = MagicReflectSpell.GetContext(target);
