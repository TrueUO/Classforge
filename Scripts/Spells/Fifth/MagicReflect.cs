...
namespace Server.Spells.Fifth
{
    public class MagicReflectSpell : MagerySpell
    {
        ...
        public override void OnCast()
        {
            ...
            */
            if (CheckSequence())
            {
                ...
                MagicReflectContext context = GetContext(targ);
        ...
        {
            MagicReflectContext context = GetContext(m);
        ...
        public static void EndReflect(MagicReflectContext context)
        {
            ...
            ResistanceMod[] mods = context.Mods;
        ...
        {
            for (int index = 0; index < m_Table.Count; index++)
            {
                MagicReflectContext c = m_Table[index];
        ...
        public class MagicReflectContext
        {
            ...
            {
                double scribe = Caster.Skills[SkillName.Inscribe].Value;
        ...
        private class CooldownTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                foreach (Mobile m in ExpireTable.Keys)
                {
