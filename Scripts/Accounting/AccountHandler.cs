...
namespace Server.Misc
{
    ...
    public class AccountHandler
    {
        ...
        {
            new CityInfo("Starting Zone", "The Cathedral", 1072214, 87, 221, -1, Map.Malas) // Church at Night
        };
        ...
        public static void Password_OnCommand(CommandEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    from.SendMessage("Your IP address does not match that which created this account.  Contact a Game Master on Discord.");
                }
            }
            catch (Exception ex)
            {
