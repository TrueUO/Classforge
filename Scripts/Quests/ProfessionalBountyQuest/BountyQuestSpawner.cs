            ...
            if (hold != null)
            {
                ...
                if (0.50 > Utility.RandomDouble())
                {
                    switch (Utility.Random(4))
                    {
                        ...
                        case 2:
                        {
                            hold.DropItem(new IronWire(Utility.RandomMinMax(1, 5))); break;
                        }
                        case 3:
                        case 4:
                        case 5:
                        {
                            hold.DropItem(new CopperWire(Utility.RandomMinMax(1, 5))); break;
                        }
                        case 6:
                        case 7:
                        {
                            hold.DropItem(new SilverWire(Utility.RandomMinMax(1, 5))); break;
                        }
                        case 8:
                        {
                            hold.DropItem(new GoldWire(Utility.RandomMinMax(1, 5))); break;
                        }
                    }
                }
                ...
                switch (Utility.Random(2))
                {
                    case 0:
                    {
                        hold.DropItem(new Cannonball(Utility.RandomMinMax(5, 10))); break;
                    }
                    case 1:
                    {
                        hold.DropItem(new Grapeshot(Utility.RandomMinMax(5, 10))); break;
                    }
                }
