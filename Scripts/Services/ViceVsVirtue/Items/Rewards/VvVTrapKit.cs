    ...
    public class VvVTrapKit : Item
    {
        ...
        public VvVTrap ConstructTrap(Mobile m)
        {
            switch (TrapType)
            {
                ...
                {
                    return new VvVExplosionTrap(m, DeploymentType);
                }
                case VvVTrapType.Poison:
                {
                    return new VvVPoisonTrap(m, DeploymentType);
                }
                case VvVTrapType.Cold:
                {
                    return new VvVColdTrap(m, DeploymentType);
                }
                case VvVTrapType.Energy:
                {
                    return new VvVEnergyTrap(m, DeploymentType);
                }
                case VvVTrapType.Blade:
                {
                    return new VvVBladeTrap(m, DeploymentType);
                }
            }
