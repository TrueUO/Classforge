...
namespace Server.Engines.VvV
{
    ...
    public class ViceVsVirtueSystem : PointsSystem
    {
        ...
        public static void CheckHarmful(Mobile attacker, Mobile defender)
        {
            ...
            for (int index = 0; index < defender.Aggressed.Count; index++)
            {
                AggressorInfo info = defender.Aggressed[index];
        ...
        {
            for (int index = 0; index < TempCombatants.Count; index++)
            {
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            {
                for (int index = 0; index < ShowNewRules.Count; index++)
                {
            ...
            for (int index = 0; index < ExemptCities.Count; index++)
            {
                VvVCity c = ExemptCities[index];
                writer.Write((int) c);
            }
            ...
            for (int index = 0; index < VvVItems.Count; index++)
            {
