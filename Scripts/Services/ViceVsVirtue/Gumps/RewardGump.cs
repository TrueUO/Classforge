        ...
        public override void OnConfirmed(CollectionItem citem, int index)
        {
            ...
            if (citem.Type == typeof(VvVPotionKeg))
            {
                ...
                switch (index)
                {
                    ...
                    case 0:
                    {
                        type = PotionType.GreaterStamina; break;
                    }
                    case 1:
                    {
                        type = PotionType.Supernova; break;
                    }
                    case 2:
                    {
                        type = PotionType.StatLossRemoval; break;
                    }
                    case 3:
                    {
                        type = PotionType.AntiParalysis; break;
                    }
                }
            ...
            else if (citem.Type == typeof(VvVTrapKit))
            {
                ...
                switch (index - 11)
                {
                    ...
                    case 0:
                    {
                        type = VvVTrapType.Poison; break;
                    }
                    case 1:
                    {
                        type = VvVTrapType.Cold; break;
                    }
                    case 2:
                    {
                        type = VvVTrapType.Energy; break;
                    }
                    case 3:
                    {
                        type = VvVTrapType.Blade; break;
                    }
                    case 4:
                    {
                        type = VvVTrapType.Explosion; break;
                    }
                }
