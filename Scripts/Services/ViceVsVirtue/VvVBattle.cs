...
namespace Server.Engines.VvV
{
    ...
    public class VvVBattle
    {
        ...
        {
            for (int index = 0; index < CityInfo.Infos[City].AltarLocs.Length; index++)
            {
        ...
        public void OnTick()
        {
            ...
            if (KillCooldown != null)
            {
                ...
                foreach (Mobile mob in KillCooldown.Keys)
                {
        ...
        public void EndBattle()
        {
            ...
            for (int index = 0; index < Altars.Count; index++)
            {
        ...
        public VvVPlayerBattleStats GetPlayerStats(PlayerMobile pm)
        {
            ...
            for (int index = 0; index < team.PlayerStats.Count; index++)
            {
                VvVPlayerBattleStats s = team.PlayerStats[index];
        ...
        public int OppositionCount(Guild g)
        {
            ...
            for (int index = 0; index < Teams.Count; index++)
            {
                ...
                {
                    for (int i = 0; i < team.Guild.Alliance.Members.Count; i++)
                    {
