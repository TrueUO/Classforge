...
namespace Server.Engines.Craft
{
    ...
    public class CraftContext
    {
        ...
        {
            AnvilOfArtifactsEntry entry = GetAnvilEntry(m, false);
        ...
        public static void OnSave(WorldSaveEventArgs e)
        {
            Persistence.Serialize(
                ...
                writer =>
                {
                    ...
                    foreach (KeyValuePair<Mobile, AnvilOfArtifactsEntry> kvp in AnvilEntries)
                    {
                    ...
                    switch (version)
                    {
                        case 1:
                        {
                            ...
                            for (int i = 0; i < count; i++)
                            {
                                ...
                                AnvilOfArtifactsEntry anvilEntry = new AnvilOfArtifactsEntry();
                        ...
                        case 0:
                        {
                            ...
                            for (int i = 0; i < count; i++)
                            {
                                CraftContext context = new CraftContext(reader);
    ...
    public class AnvilOfArtifactsEntry
    {
        ...
        {
            AnvilofArtifactsGump gump = m.FindGump<AnvilofArtifactsGump>();
        ...
        public void Serialize(GenericWriter writer)
        {
            ...
            foreach (KeyValuePair<ResistanceType, int> kvp in Exceptional)
            {
            ...
            foreach (KeyValuePair<ResistanceType, int> kvp in Runic)
            {
                writer.Write((int)kvp.Key);
                writer.Write(kvp.Value);
            }
