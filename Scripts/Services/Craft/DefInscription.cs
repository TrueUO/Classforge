    ...
    public class DefInscription : CraftSystem
    {
        ...
        private void AddSpell(Type type, params Reg[] regs)
        {
            ...
            switch (m_Circle)
            {
                ...
                case 0:
                {
                    minSkill = -25.0; maxSkill = 25.0; cliloc = 1111691; break;
                }
                case 1:
                {
                    minSkill = -10.8; maxSkill = 39.2; cliloc = 1111691; break;
                }
                case 2:
                {
                    minSkill = 03.5; maxSkill = 53.5; cliloc = 1111692; break;
                }
                case 3:
                {
                    minSkill = 17.8; maxSkill = 67.8; cliloc = 1111692; break;
                }
                case 4:
                {
                    minSkill = 32.1; maxSkill = 82.1; cliloc = 1111693; break;
                }
                case 5:
                {
                    minSkill = 46.4; maxSkill = 96.4; cliloc = 1111693; break;
                }
                case 6:
                {
                    minSkill = 60.7; maxSkill = 110.7; cliloc = 1111694; break;
                }
                case 7:
                {
                    minSkill = 75.0; maxSkill = 125.0; cliloc = 1111694; break;
                }
            }
        ...
        private int GetRegLocalization(Reg reg)
        {
            ...
            switch (reg)
            {
                ...
                case Reg.DragonBlood:
                {
                    loc = 1023970; break;
                }
                case Reg.FertileDirt:
                {
                    loc = 1023969; break;
                }
                case Reg.DaemonBone:
