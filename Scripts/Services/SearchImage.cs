...
namespace Server.Custom
{
    ...
    public class ImageDetailsGump : Gump
    {
            ...
            : base(140, 70)
        {
            ...
            AddPage(1);
            AddLabel(30, 70, 0, $"Bridge: {id.Bridge}");
            AddLabel(30, 90, 0, $"CalcHeight: {id.CalcHeight}");
            AddLabel(30, 110, 0, $"Height: {id.Height}");
            AddLabel(30, 130, 0, $"Impassable: {id.Impassable}");
            AddLabel(30, 150, 0, $"Quality: {id.Quality}");
            AddLabel(30, 170, 0, $"Quantity: {id.Quantity}");
            AddLabel(30, 190, 0, $"Surface: {id.Surface}");
            AddLabel(30, 210, 0, $"Value: {id.Value}");
            AddLabel(30, 230, 0, $"Weight: {id.Weight}");
            AddLabel(30, 250, 0, $"Flag Value: {(int) id.Flags}");
            AddLabel(30, 270, 0, $"Flags: {id.Flags}");
        }
    ...
    public class SearchImageGump : Gump
    {
            ...
            : base(0, 54)
        {
                ...
                if (list.Count > 0)
                {
                    ...
                    for (int q = index; q < index + num; q++)
                    {
                        ...
                        catch
                        {
                            ...
                            AddHtml(x, 92, 60, 120, $"Unable to show Image ID {list[q]}.", false, false);
                        }
            ...
            AddLabel(20, 520, 380, $"{list.Count} images found.");
