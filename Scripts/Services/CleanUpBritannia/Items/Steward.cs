...
namespace Server.Mobiles
{
    public class Steward : BaseCreature
    {
        ...
        {
            for (int index = 0; index < ProfanityProtection.Disallowed.Length; index++)
            {
    ...
    public class MannequinGump : Gump
    {
        ...
        public void ValidateItems(Mobile from, Mobile m)
        {
            ...
            foreach (Item item in m.Items.Where(Steward.IsEquipped))
            {
                MannequinItems.Add(item);
            }
