                ...
                if (_NextUse < DateTime.UtcNow)
                {
                    ...
                    else
                    {
                        switch (Utility.Random(6))
                        {
                            case 0:
                            {
                                item = new RancidReindeerMeat(); break;
                            }
                            case 1:
                            {
                                item = new GlassyCandyCane(); break;
                            }
                            case 2:
                            {
                                item = new NamedSeveredElfEars(); break;
                            }
                            case 3:
                            {
                                item = new SuspiciousGiftBox(); break;
                            }
                            case 4:
                            {
                                item = new InsultingDoll(); break;
                            }
                            case 5:
                            {
                                item = new SpikedEggNog(); break;
                            }
                        }
                    }
