...
namespace Server.Engines.JollyRoger
{
    ...
    public class SherryStrongBox : Container
    {
        ...
        public static void AddPermission(Mobile from)
        {
            ...
            for (int index = 0; index < Permission.Count; index++)
            {
                BoxArray x = Permission[index];
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (Controller != null)
            {
                ...
                if (Controller._List.ContainsKey(from))
                {
                    ...
                    {
                        List<string> temp = Controller._List[from].ToList();
                        temp.Add(Note);
    ...
    public class SherryTheMouse : BaseQuester
    {
        ...
        public override void OnDelete()
        {
            ...
            if (LuteList != null)
            {
                for (int index = 0; index < LuteList.Count; index++)
                {
                    Item f = LuteList[index];
