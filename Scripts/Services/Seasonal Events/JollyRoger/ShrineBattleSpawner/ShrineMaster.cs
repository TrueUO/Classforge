...
namespace Server.Engines.JollyRoger
{
    ...
    public class ShrineMaster : BaseCreature
    {
        ...
        {
            Array master = Enum.GetValues(typeof(MasterTitle));
        ...
        {
            List<PlayerMobile> toTele = SpellHelper.AcquireIndirectTargets(this, Location, Map, 12).OfType<PlayerMobile>().ToList();
