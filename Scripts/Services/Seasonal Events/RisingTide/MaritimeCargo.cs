    ...
    public class MaritimeCargo : Item
    {
        ...
        public int GetAwardAmount()
        {
            ...
            switch (_CargoQuality)
            {
                ...
                {
                    amount = Utility.RandomMinMax(100, 200); break;
                }
                case CargoQuality.Exalted:
                {
                    amount = Utility.RandomMinMax(500, 600); break;
                }
                case CargoQuality.Legendary:
                {
                    amount = Utility.RandomMinMax(1000, 1100); break;
                }
                case CargoQuality.Mythical:
                {
                    amount = Utility.RandomMinMax(10000, 10100); break;
                }
            }
