...
namespace Server.Items
{
    ...
    public class DecorativeWoodCarving : Item
    {
        ...
        public void AssignRandomName()
        {
            ...
            for (int index = 0; index < BaseBoat.Boats.Count; index++)
            {
                BaseBoat b = BaseBoat.Boats[index];
    ...
    public class PirateChest : BaseContainer, IFlipable
    {
        ...
        public override void Open(Mobile from)
        {
            switch (ItemID)
            {
                ...
                case 0xA639:
                {
                    ItemID = 0xA63B; AddTreasure(0xA63D); break;
                }
                case 0xA63A:
                {
                    ItemID = 0xA63C; AddTreasure(0xA63E); break;
                }
                case 0xA63B:
                {
                    ItemID = 0xA639; RemoveTreasure(); break;
                }
                case 0xA63C:
                {
                    ItemID = 0xA63A; RemoveTreasure(); break;
                }
            }
