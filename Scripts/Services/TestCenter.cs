...
namespace Server.Misc
{
    public class TestCenter
    {
        ...
        public static void GiveResources(Mobile from)
        {
            ...
            {
                Item item = Loot.Construct(Loot.RareGemTypes[i]);
                item.Amount = 200;
            ...
            foreach (Recipe recipe in Recipe.Recipes.Values)
            {
        ...
        public static void GiveMasteries(Mobile from)
        {
            ...
            {
                SkillName skill = MasteryInfo.Skills[i];
        ...
        public static void FillBank(Mobile m)
        {
            ...
            Runebook book = new Runebook(9999);
