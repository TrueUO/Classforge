    ...
    public class PVPArenaSystemSetupGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            for (int i = 0; i < ArenaDefinition.Definitions.Length; i++)
            {
                ...
                for (int index = 0; index < PVPArenaSystem.Arenas.Count; index++)
                {
                    PVPArena arena = PVPArenaSystem.Arenas[index];
                        ...
                        if (PVPArenaSystem.Instance != null)
                        {
                            ...
                            else
                            {
                                if (PVPArenaSystem.Arenas != null)
                                {
                                    ...
                                    for (int index = 0; index < PVPArenaSystem.Arenas.Count; index++)
                                    {
                                        PVPArena a = PVPArenaSystem.Arenas[index];
                ...
                switch (info.ButtonID)
                {
                    ...
                    case 6:
                    {
                        switch (Duel.TimeLimit)
                        {
                            case TimeLimit.FiveMinutes:
                            {
                                Duel.TimeLimit = TimeLimit.TenMinutes; break;
                            }
                            case TimeLimit.TenMinutes:
                            {
                                Duel.TimeLimit = TimeLimit.FifteenMinutes; break;
                            }
                            case TimeLimit.FifteenMinutes:
                            {
                                Duel.TimeLimit = TimeLimit.TwentyMinutes; break;
                            }
                            case TimeLimit.TwentyMinutes:
                            {
                                Duel.TimeLimit = TimeLimit.ThirtyMinutes; break;
                            }
                            case TimeLimit.ThirtyMinutes:
                            {
                                Duel.TimeLimit = TimeLimit.FiveMinutes; break;
                            }
                        }
                        Refresh();
                        break;
                    ...
                    case 7:
                    {
                        switch (Duel.EntryFee)
                        {
                            case EntryFee.Zero:
                            {
                                Duel.EntryFee = EntryFee.OneThousand; break;
                            }
                            case EntryFee.OneThousand:
                            {
                                Duel.EntryFee = EntryFee.FiveThousand; break;
                            }
                            case EntryFee.FiveThousand:
                            {
                                Duel.EntryFee = EntryFee.TenThousand; break;
                            }
                            case EntryFee.TenThousand:
                            {
                                Duel.EntryFee = EntryFee.TwentyFiveThousand; break;
                            }
                            case EntryFee.TwentyFiveThousand:
                            {
                                Duel.EntryFee = EntryFee.FiftyThousand; break;
                            }
                            case EntryFee.FiftyThousand:
                            {
                                Duel.EntryFee = EntryFee.Zero; break;
                            }
                        }
                        Refresh();
                        break;
                    ...
                    case 13:
                    {
                        switch (Duel.PotionRules)
                        {
                            case PotionRules.All:
                            {
                                Duel.PotionRules = PotionRules.None; break;
                            }
                            case PotionRules.None:
                            {
                                Duel.PotionRules = PotionRules.NoHealing; break;
                            }
                            case PotionRules.NoHealing:
                            {
                                Duel.PotionRules = PotionRules.All; break;
                            }
                        }
                        Refresh();
                        break;
