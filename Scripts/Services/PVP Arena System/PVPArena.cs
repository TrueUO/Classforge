...
namespace Server.Engines.ArenaSystem
{
    ...
    public class PVPArena
    {
        ...
        {
            foreach (ArenaDuel d in PendingDuels.Keys)
            {
        ...
        public void RemovePlayer(Mobile m, bool winner = false)
        {
            ...
            {
                for (int index = 0; index < mobile.AllFollowers.Count; index++)
                {
        ...
        public void Serialize(GenericWriter writer)
        {
            ...
            for (int index = 0; index < SurvivalRankings.Count; index++)
            {
            ...
            for (int index = 0; index < TeamRankings.Count; index++)
            {
            ...
            for (int index = 0; index < BookedDuels.Count; index++)
            {
