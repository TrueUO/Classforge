...
namespace Server.Engines.UOStore
{
    ...
    public static class UltimaStore
    {
        ...
        public static Item ConstructHairDye(Mobile m, StoreEntry entry)
        {
            ...
            for (int index = 0; index < NaturalHairDye.Table.Length; index++)
            {
                NaturalHairDye.HairDyeInfo x = NaturalHairDye.Table[index];
        ...
        public static Item ConstructHaochisPigment(Mobile m, StoreEntry entry)
        {
            ...
            for (int index = 0; index < HaochisPigment.Table.Length; index++)
            {
                HaochisPigment.HoachisPigmentInfo x = HaochisPigment.Table[index];
        ...
        public static Item ConstructEarrings(Mobile m, StoreEntry entry)
        {
            ...
            switch (entry.Name[0].Number)
            {
                case 1071092:
                {
                    ele = AosElementAttribute.Fire; break;
                }
                case 1071093:
                {
                    ele = AosElementAttribute.Cold; break;
                }
                case 1071094:
                {
                    ele = AosElementAttribute.Poison; break;
                }
                case 1071095:
                {
                    ele = AosElementAttribute.Energy; break;
                }
            }
