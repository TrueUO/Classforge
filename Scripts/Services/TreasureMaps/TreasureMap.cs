    ...
    public class TreasureMap : MapItem
    {
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            switch (facet)
            {
                ...
                {
                    list.Add(1041503); break;
                }
                case TreasureFacet.Felucca:
                {
                    list.Add(1041502); break;
                }
                case TreasureFacet.Ilshenar:
                {
                    list.Add(1060850); break;
                }
                case TreasureFacet.Malas:
                {
                    list.Add(1060851); break;
                }
                case TreasureFacet.Tokuno:
                {
                    list.Add(1115645); break;
                }
                case TreasureFacet.TerMur:
                {
                    list.Add(1115646); break;
                }
                case TreasureFacet.Eodon:
                {
                    list.Add(1158985); break;
                }
            }
