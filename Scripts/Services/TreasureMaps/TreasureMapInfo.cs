    ...
    public static class TreasureMapInfo
    {
        ...
        public static int ConvertLevel(int level)
        {
            ...
            switch (level)
            {
                default:
                {
                    return (int)TreasureLevel.Stash;
                }
                case 2:
                {
                    return (int)TreasureLevel.Supply;
                }
                case 3:
                {
                    return (int)TreasureLevel.Cache;
                }
                case 4:
                {
                    return (int)TreasureLevel.Hoard;
                }
                case 5:
                {
                    return (int)TreasureLevel.Trove;
                }
            }
        }
        ...
        public static Type[] GetWeaponList(TreasurePackage package, TreasureFacet facet)
        {
            ...
            switch (facet)
            {
                ...
                {
                    list = _WeaponTable[(int)package][0]; break;
                }
                case TreasureFacet.Ilshenar:
                {
                    list = _WeaponTable[(int)package][1]; break;
                }
                case TreasureFacet.Malas:
                {
                    list = _WeaponTable[(int)package][2]; break;
                }
                case TreasureFacet.Tokuno:
                {
                    list = _WeaponTable[(int)package][3]; break;
                }
                case TreasureFacet.TerMur:
                {
                    list = _WeaponTable[(int)package][4]; break;
                }
                case TreasureFacet.Eodon:
                {
                    list = _WeaponTable[(int)package][5]; break;
                }
            }
        ...
        public static Type[] GetArmorList(TreasurePackage package, TreasureFacet facet)
        {
            ...
            switch (facet)
            {
                ...
                case TreasureFacet.Felucca:
                {
                    list = _ArmorTable[(int)package][0]; break;
                }
                case TreasureFacet.Ilshenar:
                {
                    list = _ArmorTable[(int)package][1]; break;
                }
                case TreasureFacet.Malas:
                {
                    list = _ArmorTable[(int)package][2]; break;
                }
                case TreasureFacet.Tokuno:
                {
                    list = _ArmorTable[(int)package][3]; break;
                }
                case TreasureFacet.TerMur:
                {
                    list = _ArmorTable[(int)package][4]; break;
                }
                case TreasureFacet.Eodon:
                {
                    list = _ArmorTable[(int)package][5]; break;
                }
            }
        ...
        public static Recipe[] GetRecipeList(TreasureLevel level, TreasurePackage package)
        {
            if (package == TreasurePackage.Artisan && level == TreasureLevel.Supply)
            {
                ...
                foreach (Recipe value in Recipe.Recipes.Values)
                {
        ...
        public static int GetGemCount(ChestQuality quality, TreasureLevel level)
        {
            ...
            switch (quality)
            {
                case ChestQuality.Rusty:
                {
                    baseAmount = 7; break;
                }
                case ChestQuality.Standard:
                {
                    baseAmount = Utility.RandomBool() ? 7 : 9; break;
                }
                case ChestQuality.Gold:
                {
                    baseAmount = Utility.RandomList(7, 9, 11); break;
                }
            }
        ...
        public static int GetGoldCount(TreasureLevel level)
        {
            switch (level)
            {
                ...
                {
                    return Utility.RandomMinMax(10000, 40000);
                }
                case TreasureLevel.Supply:
                {
                    return Utility.RandomMinMax(20000, 50000);
                }
                case TreasureLevel.Cache:
                {
                    return Utility.RandomMinMax(30000, 60000);
                }
                case TreasureLevel.Hoard:
                {
                    return Utility.RandomMinMax(40000, 70000);
                }
                case TreasureLevel.Trove:
                {
                    return Utility.RandomMinMax(50000, 70000);
                }
            }
        }
        ...
        public static int GetEquipmentAmount(Mobile from, TreasureLevel level, TreasurePackage package)
        {
            ...
            switch (level)
            {
                ...
                case TreasureLevel.Cache:
                {
                    amount = package == TreasurePackage.Assassin ? 24 : 12; break;
                }
                case TreasureLevel.Hoard:
                {
                    amount = 18; break;
        ...
        public static void GetMinMaxBudget(TreasureLevel level, Item item, out int min, out int max)
        {
            ...
            switch (level)
            {
                ...
                case TreasureLevel.Supply:
                {
                    min = 250; max = preArtifact; break;
                }
                case TreasureLevel.Cache:
                case TreasureLevel.Hoard:
                case TreasureLevel.Trove:
                {
                    min = 500; max = 1300; break;
                }
            }
        }
        ...
        private static readonly Type[] _FunctionalMinorArtifacts =
        {
            ...
            typeof(IolosLute), typeof(NightsKiss), typeof(PolarBearMask),
            typeof(HeartOfTheLion), typeof(AlchemistsBauble)
        };
        ...
        public static void Fill(Mobile from, TreasureMapChest chest, TreasureMap tMap)
        {
            ...
            if (amount > 0)
            {
                ...
                for (int index = 0; index < Loot.GemTypes.Length; index++)
                {
            ...
            if (amount > 0)
            {
                ...
                if (pscrollList != null)
                {
                    for (int index = 0; index < pscrollList.Length; index++)
                    {
            ...
            switch (level)
            {
                case TreasureLevel.Stash:
                {
                    dropChance = 0.00; break;
                }
                case TreasureLevel.Supply:
                {
                    dropChance = 0.10; break;
                }
                case TreasureLevel.Cache:
                {
                    dropChance = 0.20; break;
                }
                case TreasureLevel.Hoard:
                {
                    dropChance = 0.40; break;
                }
                case TreasureLevel.Trove:
                {
                    dropChance = 0.50; break;
                }
            }
            ...
            if (Utility.RandomDouble() < dropChance)
            {
                ...
                if (list != null)
                {
                    if (list.Length > 0)
                    {
                        ...
                        for (int index = 0; index < _DecorativeMinorArtifacts.Length; index++)
                        {
                            Type t = _DecorativeMinorArtifacts[index];
            ...
            if (Utility.RandomDouble() < dropChance)
            {
                ...
                if (list != null)
                {
                    if (list.Length > 0)
                    {
                        ...
                        for (int index = 0; index < _FunctionalMinorArtifacts.Length; index++)
                        {
