        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (m_UsesRemaining > 0)
            {
                ...
                switch (Utility.Random(10))
                {
                    case 0:
                    {
                        item = new SweetPotatoPie(); break;
                    }
                    case 1:
                    {
                        item = new MashedSweetPotatoes(); break;
                    }
                    case 2:
                    {
                        item = new BasketOfRolls(); break;
                    }
                    case 3:
                    {
                        item = new TurkeyPlatter(); break;
                    }
                    case 4:
                    {
                    ...
                    case 6:
                    {
                        item = new PottedCoffeePlant(); break;
                    }
                    case 7:
                    {
                        item = new RoastingPigOnASpitDeed(); break;
                    }
                    case 8:
                    {
                        item = new FormalDiningTableDeed(); break;
                    }
                    case 9:
                    {
                        item = new BuffetTableDeed(); break;
                    }
                }
