        ...
        public override void OnConfirmed(CollectionItem citem, int index)
        {
            if (citem.Type == typeof(RecipeScroll))
            {
                ...
                switch (citem.Tooltip.Number)
                {
                    ...
                    case 1158769:
                    {
                        item = new RecipeScroll(605); break;
                    }
                    case 1158770:
                    {
                        item = new RecipeScroll(606); break;
                    }
                    case 1158771:
                    {
                        item = new RecipeScroll(607); break;
                    }
                    case 1159204:
                    {
                        item = new RecipeScroll(608); break;
                    }
                    case 1159205:
                    {
                        item = new RecipeScroll(609); break;
                    }
                    case 1159206:
                    {
                        item = new RecipeScroll(610); break;
                    }
                }
