...
namespace Server.AccountVault
{
    ...
    public class VaultActionsGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            PlayerProfile store = UltimaStore.GetProfile(User);
            IAccount acct = User.Account;
    ...
    public class VaultLocationsGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            int locs = SystemSettings.VaultRegions.Length;
            ...
            {
                string region = SystemSettings.VaultRegions[i];
        ...
        public static int VaultCount(string region)
        {
            ...
            for (int index = 0; index < AccountVault.Vaults.Count; index++)
            {
                AccountVault v = AccountVault.Vaults[index];
