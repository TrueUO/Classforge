...
namespace Server.Engines.VendorSearching
{
    public class VendorSearch
    {
        ...
        public static List<SearchItem> DoSearchAuction(SearchCriteria criteria)
        {
            ...
            for (int index = 0; index < criteria.Details.Count; index++)
            {
                SearchDetail d = criteria.Details[index];
            ...
            for (int index = 0; index < Auction.Auction.Auctions.Count; index++)
            {
        ...
        public static bool CheckMatch(Item item, int price, SearchCriteria searchCriteria)
        {
            ...
            for (int index = 0; index < searchCriteria.Details.Count; index++)
            {
        ...
        private static List<Item> GetItems(Mobile pv)
        {
            ...
            for (int index = 0; index < pv.Items.Count; index++)
            {
        ...
        {
            for (int index = 0; index < _SearchableContainers.Length; index++)
            {
                Type t = _SearchableContainers[index];
    ...
    public class SearchCategory
    {
        ...
        public void Register(object o, int label)
        {
            ...
            {
                Tuple<object, int, int> t = Objects[index];
    ...
    public class SearchCriteria
    {
        ...
        public void TryAddDetails(object o, int name, int propname, int value, Category cat)
        {
            ...
            for (int index = 0; index < Details.Count; index++)
            {
                SearchDetail det = Details[index];
