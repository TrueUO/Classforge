        ...
        public static void Setup(CommandEventArgs e)
        {
            ...
            foreach (int c in Enum.GetValues(typeof(City)))
            {
                ...
                switch (city)
                {
                    case City.Moonglow:
                    {
                        sys = CityLoyaltySystem.Moonglow; break;
                    }
                    case City.Britain:
                    {
                        sys = CityLoyaltySystem.Britain; break;
                    }
                    case City.Jhelom:
                    {
                        sys = CityLoyaltySystem.Jhelom; break;
                    }
                    case City.Yew:
                    {
                        sys = CityLoyaltySystem.Yew; break;
                    }
                    case City.Minoc:
                    {
                        sys = CityLoyaltySystem.Minoc; break;
                    }
                    case City.Trinsic:
                    {
                        sys = CityLoyaltySystem.Trinsic; break;
                    }
                    case City.SkaraBrae:
                    {
                        sys = CityLoyaltySystem.SkaraBrae; break;
                    }
                    case City.NewMagincia:
                    {
                        sys = CityLoyaltySystem.NewMagincia; break;
                    }
                    case City.Vesper:
                    {
                        sys = CityLoyaltySystem.Vesper; break;
                    }
                }
