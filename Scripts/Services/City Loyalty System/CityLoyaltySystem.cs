...
namespace Server.Engines.CityLoyalty
{
    ...
    public class CityLoyaltySystem : PointsSystem
    {
        ...
        public static Map SystemMap => Map.Trammel;
        ...
        public static void ActivateTradeDeal(Mobile m, TradeDeal deal)
        {
            switch (deal)
            {
                ...
                {
                    m.AddStatMod(new StatMod(StatType.Dex, $"TradeDeal_{StatType.Dex}", 3, TimeSpan.Zero)); break;
                }
                case TradeDeal.MiningCooperative:
                {
                    m.AddStatMod(new StatMod(StatType.Str, $"TradeDeal_{StatType.Str}", 3, TimeSpan.Zero)); break;
                }
                case TradeDeal.LeagueOfRangers:
                {
                    m.AddStatMod(new StatMod(StatType.Int, $"TradeDeal_{StatType.Int}", 3, TimeSpan.Zero)); break;
                }
            }
        }
