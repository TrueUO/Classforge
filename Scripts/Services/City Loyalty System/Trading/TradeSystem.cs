    ...
    public class CityTradeSystem : PointsSystem
    {
        ...
        public void CheckTitle(CityTradeEntry entry)
        {
            switch (entry.Completed)
            {
                case 1:
                {
                    entry.Player.AddRewardTitle((int)TradeTitle.Trader); break;
                }
                case 25:
                {
                    entry.Player.AddRewardTitle((int)TradeTitle.Exporter); break;
                }
                case 50:
                {
                    entry.Player.AddRewardTitle((int)TradeTitle.Broker); break;
                }
                case 100:
                {
                    entry.Player.AddRewardTitle((int)TradeTitle.Tycoon); break;
                }
                case 150:
                {
                    entry.Player.AddRewardTitle((int)TradeTitle.Magnate); break;
                }
            }
