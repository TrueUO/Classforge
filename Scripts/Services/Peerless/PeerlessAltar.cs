...
namespace Server.Items
{
    ...
    public abstract class PeerlessAltar : Container
    {
        ...
        public virtual void FinishSequence()
        {
            ...
            if (Fighters != null)
            {
                List<Mobile> fighters = new List<Mobile>(Fighters);

                for (int index = 0; index < fighters.Count; index++)
                {
                    Mobile x = fighters[index];
            ...
            if (MasterKeys != null)
            {
                List<Item> keys = new List<Item>(MasterKeys);
        ...
        public virtual bool MobileIsInBossArea(Point3D loc)
        {
            ...
            for (int index = 0; index < BossBounds.Length; index++)
            {
