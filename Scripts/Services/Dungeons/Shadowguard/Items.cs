    ...
    public class ShadowguardCypress : Item
    {
        ...
        public bool IsOppositeVirtue(VirtueType type)
        {
            switch (type)
            {
                ...
                {
                    return VirtueType == VirtueType.Deceit;
                }
                case VirtueType.Compassion:
                {
                    return VirtueType == VirtueType.Despise;
                }
                case VirtueType.Valor:
                {
                    return VirtueType == VirtueType.Destard;
                }
                case VirtueType.Justice:
                {
                    return VirtueType == VirtueType.Wrong;
                }
                case VirtueType.Sacrafice:
                {
                    return VirtueType == VirtueType.Covetous;
                }
                case VirtueType.Honor:
                {
                    return VirtueType == VirtueType.Shame;
                }
                case VirtueType.Spirituality:
                {
                    return VirtueType == VirtueType.Hythloth;
                }
                case VirtueType.Humility:
                {
                    return VirtueType == VirtueType.Pride;
                }
                case VirtueType.Deceit:
                {
                    return VirtueType == VirtueType.Honesty;
                }
                case VirtueType.Despise:
                {
                    return VirtueType == VirtueType.Compassion;
                }
                case VirtueType.Destard:
                {
                    return VirtueType == VirtueType.Valor;
                }
                case VirtueType.Wrong:
                {
                    return VirtueType == VirtueType.Justice;
                }
                case VirtueType.Covetous:
                {
                    return VirtueType == VirtueType.Sacrafice;
                }
                case VirtueType.Shame:
                {
                    return VirtueType == VirtueType.Honor;
                }
                case VirtueType.Hythloth:
                {
                    return VirtueType == VirtueType.Spirituality;
                }
                case VirtueType.Pride:
                {
                    return VirtueType == VirtueType.Humility;
                }
            }
        }
