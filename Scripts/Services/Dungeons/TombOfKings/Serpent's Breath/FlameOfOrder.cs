...
namespace Server.Items
{
    public class FlameOfOrder : Item
    {
            ...
            : base(0x19AB)
        {
            ...
            for (int index = 0; index < m_BarrierLocations.Length; index++)
            {
            ...
            for (int index = 0; index < m_MsgTriggerLocations.Length; index++)
            {
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (Visible && e.Mobile.InRange(this, 2) && mantra == "ord")
            {
                ...
                for (int index = 0; index < m_Blockers.Count; index++)
                {
                    Blocker blocker = m_Blockers[index];
                    blocker.Delete();
                }

                for (int index = 0; index < m_LOSBlockers.Count; index++)
                {
        ...
        public override void OnAfterDelete()
        {
            ...
            for (int index = 0; index < m_MsgTriggers.Count; index++)
            {
