...
namespace Server.Engines.VoidPool
{
    public static class Generate
    {
        ...
        public static void AddWaypoints()
        {
            ...
            for (int index = 0; index < one.WaypointsA.Count; index++)
            {
            ...
            for (int index = 0; index < one.WaypointsB.Count; index++)
            {
            ...
            for (int index = 0; index < two.WaypointsA.Count; index++)
            {
            ...
            for (int index = 0; index < two.WaypointsB.Count; index++)
            {
        ...
        public static void ConvertRegionSpawners(Region r)
        {
            ...
            for (int index = 0; index < r.Sectors.Length; index++)
            {
                Sector s = r.Sectors[index];

                for (int index1 = 0; index1 < s.Items.Count; index1++)
                {
                    Item i = s.Items[index1];

                    if (i is XmlSpawner spawner && _SpawnerBounds.Contains(i))
                    {
                        for (int i1 = 0; i1 < spawner.SpawnObjects.Length; i1++)
                        {
