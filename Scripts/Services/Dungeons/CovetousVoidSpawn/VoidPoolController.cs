        ...
        public void SpawnWave()
        {
            ...
            for (int i = 0; i < toSpawn; i++)
            {
                ...
                switch (ran)
                {
                    ...
                    case 4:
                    {
                        t = SpawnTable[(int)VoidType][0]; break;
                    }
                    case 5: case 6: case 7: case 8:
                    {
                        t = SpawnTable[(int)VoidType][1]; break;
                    }
                    case 9: case 10: case 11:
                    {
                        t = SpawnTable[(int)VoidType][2]; break;
                    }
                    case 12: case 13:
                    {
                        t = SpawnTable[(int)VoidType][3]; break;
                    }
                    case 14: case 15:
                    {
                        t = SpawnTable[(int)VoidType][4]; break;
                    }
                }
