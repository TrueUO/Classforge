    ...
    public class ScoresGump : Gump
    {
        ...
        public void AddGumpLayout()
        {
            ...
            switch (ScoreType)
            {
                ...
                {
                    Score = Controller.CurrentScore; loc = 1152535; break;
                }
                case ScoreType.BestSingle:
                {
                    Score = stats.BestSingle; loc = 1152536; break;
                }
                case ScoreType.OverallTotal:
                {
                    Score = stats.OverallTotal; loc = 1152537; break;
                }
                case ScoreType.BestWave:
                {
                    Score = stats.BestWave.Score; loc = "Best Wave Scoreboard"; break;
                }
            }
