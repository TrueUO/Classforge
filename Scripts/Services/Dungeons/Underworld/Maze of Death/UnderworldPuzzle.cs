    ...
    public class UnderworldPuzzleGump : Gump
    {
        ...
        private int GetTotalPieces(PuzzlePiece piece)
        {
            switch (piece)
            {
                ...
                case PuzzlePiece.RedSingle: case PuzzlePiece.BlueSingle: case PuzzlePiece.GreenSingle:
                {
                    return 1;
                }
                case PuzzlePiece.RedDouble: case PuzzlePiece.BlueDouble: case PuzzlePiece.GreenDouble:
                {
                    return 2;
                }
                case PuzzlePiece.RedTriple: case PuzzlePiece.BlueTriple: case PuzzlePiece.GreenTriple:
                {
                    return 3;
                }
                case PuzzlePiece.RedBar: case PuzzlePiece.BlueBar: case PuzzlePiece.GreenBar:
                {
                    return 4;
                }
            }
