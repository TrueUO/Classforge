    ...
    public class BedrollSpawner : Item
    {
        ...
        private void CheckRespawn()
        {
            ...
            for (int i = 0; i < m_OutsideTunnels.Length; i++)
            {
                ...
                else
                {
                    ...
                    for (int index = 0; index < Bedrolls.Count; index++)
                    {
                        WrongBedrollBase x = Bedrolls[index];
        ...
        public void Cleanup()
        {
            if (Bedrolls != null)
            {
                for (int index = 0; index < Bedrolls.Count; index++)
                {
                    WrongBedrollBase f = Bedrolls[index];
                    f.Delete();
                }
            ...
            {
                for (int index = 0; index < MysteriousTunnels.Count; index++)
                {
                    MysteriousTunnel f = MysteriousTunnels[index];
                    f.Delete();
                }
