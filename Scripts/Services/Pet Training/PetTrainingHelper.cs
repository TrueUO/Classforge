...
namespace Server.Mobiles
{
    ...
    public static class PetTrainingHelper
    {
        ...
        public static TrainingDefinition GetTrainingDefinition(BaseCreature bc)
        {
            ...
            {
                TrainingDefinition d = Definitions[index];
        ...
        {
            for (int index = 0; index < _TrainingPoints.Count; index++)
            {
        ...
        public static readonly WeaponAbility[] WepAbility11 =
{
        ...
        public static int GetTotalCost(TrainingPoint tp, BaseCreature bc, int value, int startValue)
        {
            ...
            {
                for (int index = 0; index < tp.Requirements.Length; index++)
                {
        ...
        public static bool ValidateTrainingPoint(BaseCreature bc, SpecialAbility ability)
        {
            ...
            for (int index = 0; index < def.SpecialAbilities.Length; index++)
            {
                SpecialAbility a = def.SpecialAbilities[index];
        ...
        public static bool ValidateTrainingPoint(BaseCreature bc, AreaEffect ability)
        {
            ...
            for (int index = 0; index < def.AreaEffects.Length; index++)
            {
                AreaEffect a = def.AreaEffects[index];
        ...
        public static bool ValidateTrainingPoint(BaseCreature bc, WeaponAbility ability)
        {
            ...
            for (int index = 0; index < def.WeaponAbilities.Length; index++)
            {
                WeaponAbility a = def.WeaponAbilities[index];
        ...
        public static TextDefinition[] GetLocalization(SkillName skill)
        {
            ...
            for (int index = 0; index < _TrainingPoints.Count; index++)
            {
                TrainingPoint t = _TrainingPoints[index];
        ...
        public static int GetCategoryLocalization(object o)
        {
            ...
            {
                for (int index = 0; index < CombatSkills.Length; index++)
                {
