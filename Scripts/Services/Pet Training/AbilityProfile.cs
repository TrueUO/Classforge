    ...
    public class AbilityProfile
    {
        ...
        public bool AddAbility(WeaponAbility ability, bool advancement = true)
        {
            ...
            else
            {
                ...
                for (int index = 0; index < WeaponAbilities.Length; index++)
                {
                    WeaponAbility a = WeaponAbilities[index];
        ...
        public void RemoveAbility(SpecialAbility ability)
        {
            ...
            for (int index = 0; index < SpecialAbilities.Length; index++)
            {
                SpecialAbility specialAbility = SpecialAbilities[index];
        ...
        public void RemoveAbility(WeaponAbility ability)
        {
            ...
            for (int index = 0; index < WeaponAbilities.Length; index++)
            {
                WeaponAbility weaponAbility = WeaponAbilities[index];
        ...
        public void OnAddAbility(object newAbility, bool advancement)
        {
            ...
            {
                for (int index = 0; index < trainPoint.Requirements.Length; index++)
                {
        ...
        public bool CanChooseSpecialAbility(SpecialAbility[] list)
        {
            ...
            {
                SpecialAbility abil = list[index];
        ...
        {
            for (int index = 0; index < PetTrainingHelper.RuleBreakers.Length; index++)
            {
                SpecialAbility abil = PetTrainingHelper.RuleBreakers[index];
        ...
        public bool IsNaturalAbility(object o)
        {
            ...
            if (o is SpecialAbility specialAbility)
            {
                ...
                for (int index = 0; index < Advancements.Count; index++)
                {
                    object s = Advancements[index];
        ...
        public IEnumerable<object> EnumerateAllAbilities()
        {
            if (MagicalAbility != MagicalAbility.None)
            {
                for (int index = 0; index < PetTrainingHelper.MagicalAbilities.Length; index++)
                {
        ...
        public SpecialAbility[] GetSpecialAbilities()
        {
            ...
            foreach (SpecialAbility ability in EnumerateSpecialAbilities())
            {
                list.Add(ability);
            }
        ...
        public AreaEffect[] GetAreaEffects()
        {
            ...
            foreach (AreaEffect effect in EnumerateAreaEffects())
            {
                list.Add(effect);
            }
