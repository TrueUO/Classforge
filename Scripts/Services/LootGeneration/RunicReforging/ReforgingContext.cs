...
namespace Server.Items
{
    public class ReforgingContext
    {
            ...
            switch (version)
            {
                case 1:
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        ReforgingInfo info = new ReforgingInfo((ReforgingOption)reader.ReadInt(), (ReforgedPrefix)reader.ReadInt(), (ReforgedSuffix)reader.ReadInt());
        ...
        public void Serialize(GenericWriter writer)
        {
            ...
            foreach (KeyValuePair<BaseTool, ReforgingInfo> kvp in Contexts)
            {
