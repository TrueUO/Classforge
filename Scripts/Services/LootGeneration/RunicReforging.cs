    ...
    public static class RunicReforging
    {
        public static void ApplyReforgedProperties(Item item, List<int> props, ReforgedPrefix prefix, ReforgedSuffix suffix, int budget, int perclow, int perchigh, int maxmods, int luckchance)
        {
            ...
            if (prefix == ReforgedPrefix.None && (suffix == ReforgedSuffix.None || suffix > ReforgedSuffix.Aegis))
            {
                ...
                {
                    ApplyRandomProperty(item, props, perclow, perchigh, ref budget, luckchance, powerful);
                }
                ...
                if (prefix != ReforgedPrefix.None && suffix == ReforgedSuffix.None && prefixCol != null)
                {
                    ...
                    while (budget > 25 && mods < maxmods && i < 25)
                    {
                        if (prefixCol.Count > 0 && specialAdd > 0)
                        {
                            ...
                            if (ApplyPrefixSuffixAttribute(item, prefixCol[random], perclow, perchigh, ref budget, luckchance, powerful))
                            {
                                specialAdd--;
                                mods++;
                            }
                        ...
                        else if (ApplyRandomProperty(item, props, perclow, perchigh, ref budget, luckchance, powerful))
                        {
                            mods++;
                        }
                ...
                else if (prefix == ReforgedPrefix.None && suffix != ReforgedSuffix.None && suffixCol != null)
                {
                    ...
                    while (budget > 25 && mods < maxmods && i < 25)
                    {
                        if (suffixCol.Count > 0 && specialAdd > 0)
                        {
                            ...
                            if (ApplyPrefixSuffixAttribute(item, suffixCol[random], perclow, perchigh, ref budget, luckchance, powerful))
                            {
                                specialAdd--;
                                mods++;
                            }
        ...
        private static void GetNamedModCount(int prefixID, int suffixID, int maxmods, int precolcount, int suffixcolcount, ref int prefixCount, ref int suffixCount)
        {
            ...
            else
            {
                ...
                switch (maxmods)
                {
                    ...
                    case 4:
                    {
                        mods = Utility.RandomBool() ? 2 : 3; break;
                    }
                    case 3:
                    {
                        mods = Utility.RandomBool() ? 1 : 2; break;
                    }
                    case 2:
                    case 1:
                    {
        ...
        private static bool ApplyPrefixSuffixAttribute(Item item, NamedInfoCol col, int percLow, int percHigh, ref int budget, int luckchance, bool powerful)
        {
            int start = budget;
            ...
            if (attribute is string s)
            {
                switch (s)
                {
                    case "RandomEater":
                    {
                        attribute = GetRandomEater(); break;
                    }
                    case "HitSpell":
                    {
                        attribute = GetRandomHitSpell(); break;
                    }
                    case "HitArea":
                    {
                        attribute = GetRandomHitArea(); break;
                    }
                    case "Slayer":
                    {
                        attribute = BaseRunicTool.GetRandomSlayer(); break;
                    }
                    case "WeaponVelocity":
                    {
                        break;
                    ...
                    {
                        attribute = GetRandomElemental(); break;
                    }
                }
            }
            ...
            ApplyProperty(item, id, percLow, percHigh, ref budget, luckchance, powerful); // TODO: powerful

            return start != budget;
        }

        public static int Scale(int min, int max, int perclow, int perchigh, int luckchance)
        {
        ...
        private static int CalculateValue(Item item, object attribute, int min, int max, int perclow, int perchigh, ref int budget, int luckchance)
        {
            ...
            int value = Scale(min, max, perclow, perchigh, luckchance);
        ...
        private static AosElementAttribute GetRandomElemental()
        {
            switch (Utility.Random(5))
            {
                ...
                case 4:
                {
                    return AosElementAttribute.Chaos;
                }
            }
        }
        ...
        public static void GenerateRandomItem(Item item, Mobile killer, int basebudget, int luckchance, ReforgedPrefix forcedprefix, ReforgedSuffix forcedsuffix, Map map = null, bool artifact = false, int additionalMaxProps = 0)
        {
            ...
            if (item != null)
            {
                ...
                if (addonbudget > 0)
                {
                    for (int i = 0; i < 5; i++)
                    {
                        ApplyRandomProperty(item, props, perclow, perchigh, ref addonbudget, luckchance, powerful);
                ...
                if (artifact && power < ItemPower.LesserArtifact)
                {
                    ...
                    do
                    {
                        ApplyRandomProperty(item, props, perclow, perchigh, ref extra, luckchance, powerful);
                    }
                ...
                switch (suffix)
                {
                    ...
                    case ReforgedSuffix.Fellowship:
                    {
                        item.Hue = 2751; break;
                    }
                }
        ...
        public static int GetProperties(int max, int additionalMaxProps = 0)
        {
            ...
            switch (max)
            {
                ...
                case 2:
                {
                    p0 = 6; p1 = 3; p2 = 1; break;
                }
                case 3:
                {
                    p0 = 10; p1 = 6; p2 = 3; p3 = 1; break;
                }
                case 4:
                {
                    p0 = 16; p1 = 12; p2 = 6; p3 = 5; p4 = 1; break;
                }
                case 5:
                {
                    p0 = 30; p1 = 25; p2 = 20; p3 = 15; p4 = 9; p5 = 1; break;
                }
                case 6:
                {
                    p0 = 35; p1 = 30; p2 = 25; p3 = 20; p4 = 15; p5 = 9; p6 = 1; break;
                }
                case 7:
                {
                    p0 = 40; p1 = 35; p2 = 30; p3 = 25; p4 = 20; p5 = 15; p6 = 9; p7 = 1; break;
                }
                case 8:
                {
                    p0 = 50; p1 = 40; p2 = 35; p3 = 30; p4 = 25; p5 = 20; p6 = 15; p7 = 9; p8 = 1; break;
                }
                case 9:
                {
                    p0 = 70; p1 = 55; p2 = 45; p3 = 35; p4 = 30; p5 = 25; p6 = 20; p7 = 15; p8 = 9; p9 = 1; break;
                }
                case 10:
                {
                    p0 = 90; p1 = 70; p2 = 55; p3 = 45; p4 = 40; p5 = 35; p6 = 25; p7 = 15; p8 = 10; p9 = 5; p10 = 1; break;
                }
            }
        ...
        private static bool ApplyRandomProperty(Item item, IList<int> props, int perclow, int perchigh, ref int budget, int luckchance, bool powerful)
        {
            ...
            return ApplyProperty(item, id, perclow, perchigh, ref budget, luckchance, powerful);
        }
        ...
        /// <returns></returns>
        public static bool ApplyProperty(Item item, int id, int perclow, int perchigh, ref int budget, int luckchance, bool powerful)
        {
            ...
            int value = CalculateValue(item, ItemPropertyInfo.GetAttribute(id), min, max, perclow, perchigh, ref budget, luckchance);
