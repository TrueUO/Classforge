...
namespace Server.SkillHandlers
{
    public class Imbuing
    {
            ...
            if (id >= 51 && id <= 55)
            {
                if (item is BaseArmor armor)
                {
                    switch (id)
                    {
                        case 51:
                        {
                            armor.PhysNonImbuing = 0; break;
                        }
                        case 52:
                        {
                            armor.FireNonImbuing = 0; break;
                        }
                        case 53:
                        {
                            armor.ColdNonImbuing = 0; break;
                        }
                        case 54:
                        {
                            armor.PoisonNonImbuing = 0; break;
                        }
                        case 55:
                        {
                            armor.EnergyNonImbuing = 0; break;
                        }
                    }
                }
                else if (item is BaseClothing hat)
                {
                    switch (id)
                    {
                        case 51:
                        {
                            hat.PhysNonImbuing = 0; break;
                        }
                        case 52:
                        {
                            hat.FireNonImbuing = 0; break;
                        }
                        case 53:
                        {
                            hat.ColdNonImbuing = 0; break;
                        }
                        case 54:
                        {
                            hat.PoisonNonImbuing = 0; break;
                        }
                        case 55:
                        {
                            hat.EnergyNonImbuing = 0; break;
                        }
                    }
                }
            }
        ...
        private static readonly Type[] m_IngredTypes =
        {
            ...
            typeof(CrushedGlass),       typeof(CrystallineBlackrock),   
