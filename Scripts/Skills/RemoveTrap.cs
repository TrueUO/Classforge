            ...
            : base(TimeSpan.FromSeconds(10), TimeSpan.FromSeconds(10))
        {
            ...
            if (gmRemover)
            {
                ...
                switch ((TreasureLevel)chest.Level)
                {
                    ...
                    {
                        duration = TimeSpan.FromSeconds(20); break;
                    }
                    case TreasureLevel.Supply:
                    {
                        duration = TimeSpan.FromSeconds(60); break;
                    }
                    case TreasureLevel.Cache:
                    {
                        duration = TimeSpan.FromSeconds(180); break;
                    }
                    case TreasureLevel.Hoard:
                    {
                        duration = TimeSpan.FromSeconds(420); break;
                    }
                    case TreasureLevel.Trove:
                    {
                        duration = TimeSpan.FromSeconds(540); break;
                    }
                }
