...
namespace Server.SkillHandlers
{
    public class DetectHidden
    {
        ...
        public static bool CanDetect(Mobile src, Mobile target, bool direct)
        {
            ...
            for (int index = 0; index < src.Aggressed.Count; index++)
            {
                AggressorInfo x = src.Aggressed[index];
            ...
            for (int index = 0; index < src.Aggressors.Count; index++)
            {
                AggressorInfo x = src.Aggressors[index];
