...
namespace Server.Gumps
{
    ...
    public class CircuitTrapGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            {
                default:
                case CircuitCount.Nine:
                {
                    size = 150; break;
                }
                case CircuitCount.Sixteen:
                {
                    size = 190; break;
                }
                case CircuitCount.TwentyFive:
                {
                    size = 230; break;
                }
                case CircuitCount.ThirtySix:
                {
                    size = 270; break;
                }
            }
        ...
        public override void OnResponse(RelayInfo info)
        {
            ...
            if (info.ButtonID > 0 && info.ButtonID < 5)
            {
                ...
                switch (id)
                {
                    ...
                    case 1:
                    {
                        pick = current - perRow; break;
                    }
                    case 2:
                    {
                        pick = current + 1; break;
                    }
                    case 3:
                    {
                        pick = current + perRow; break;
        ...
        public List<int> GetRandomPath()
        {
            switch (Count)
            {
                ...
                case CircuitCount.Nine:
                {
                    return Paths9[Utility.Random(Paths9.Length)].ToList();
                }
                case CircuitCount.Sixteen:
                {
                    return Paths16[Utility.Random(Paths16.Length)].ToList();
                }
                case CircuitCount.TwentyFive:
                {
                    return Paths25[Utility.Random(Paths25.Length)].ToList();
                }
                case CircuitCount.ThirtySix:
                {
                    return Paths36[Utility.Random(Paths36.Length)].ToList();
                }
            }
        }
    }
