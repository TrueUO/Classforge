                        ...
                        if (Config.Get("Staff.Staffbody", true))
                        {
                            ...
                            if (Config.Get("Staff.UseColoring", true))
                            {
                                switch (m_Mobile.AccessLevel)
                                {
                                    ...
                                    {
                                        m_Mobile.Hue = Config.Get("Staff.Owner", 1001); break;
                                    }
                                    case AccessLevel.Developer:
                                    {
                                        m_Mobile.Hue = Config.Get("Staff.Developer", 1001); break;
                                    }
                                    case AccessLevel.Administrator:
                                    {
                                        m_Mobile.Hue = Config.Get("Staff.Administrator", 1001); break;
                                    }
                                    case AccessLevel.Seer:
                                    {
                                        m_Mobile.Hue = Config.Get("Staff.Seer", 467); break;
                                    }
                                    case AccessLevel.GameMaster:
                                    {
                                        m_Mobile.Hue = Config.Get("Staff.GameMaster", 39); break;
                                    }
                                    case AccessLevel.Counselor:
                                    {
                                        m_Mobile.Hue = Config.Get("Staff.Counselor", 3); break;
                                    }
                                }
                            }
                        }
                        ...
                        if (Config.Get("Staff.GiveBoots", true))
                        {
                            ...
                            if (Config.Get("Staff.UseColoring", true))
                            {
                                switch (m_Mobile.AccessLevel)
                                {
                                    case AccessLevel.Owner:
                                    {
                                        color = Config.Get("Staff.Owner", 1001); break;
                                    }
                                    case AccessLevel.Developer:
                                    {
                                        color = Config.Get("Staff.Developer", 1001); break;
                                    }
                                    case AccessLevel.Administrator:
                                    {
                                        color = Config.Get("Staff.Administrator", 1001); break;
                                    }
                                    case AccessLevel.Seer:
                                    {
                                        color = Config.Get("Staff.Seer", 467); break;
                                    }
                                    case AccessLevel.GameMaster:
                                    {
                                        color = Config.Get("Staff.GameMaster", 39); break;
                                    }
                                    case AccessLevel.Counselor:
                                    {
                                        color = Config.Get("Staff.Counselor", 3); break;
                                    }
                                }
                            }
