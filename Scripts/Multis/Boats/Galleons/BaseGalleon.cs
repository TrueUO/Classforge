...
namespace Server.Multis
{
    ...
    public abstract class BaseGalleon : BaseBoat
    {
        ...
        {
            for (int index = 0; index < HoldItemIDs.Length; index++)
            {
                int listId = HoldItemIDs[index];
        ...
        {
            for (int index = 0; index < HoldIDs.Length; index++)
            {
                int listId = HoldIDs[index];
        ...
        {
            for (int index = 0; index < WheelItemIDs.Length; index++)
            {
                int listId = WheelItemIDs[index];
        ...
        {
            for (int index = 0; index < CannonTileIDs.Length; index++)
            {
                int listId = CannonTileIDs[index];
        ...
        public bool CanAddAddon(Point3D p)
        {
            ...
            foreach (object o in eable)
            {
                if (o is DeckItem item)
                {
                    ...
                    for (int index = 0; index < m_ShipAddonTiles.Length; index++)
                    {
                        int id = m_ShipAddonTiles[index];
