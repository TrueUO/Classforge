        ...
        public virtual void InitOutfit()
        {
            if (Map == Map.Tokuno)
            {
                ...
                else
                {
                    switch (Utility.Random(2))
                    {
                        ...
                        case 1:
                        {
                            SetWearable(new HakamaShita(GetRandomHue())); break;
                        }
                    }
                    switch (Utility.Random(2))
                    {
                        case 0:
                        {
                            SetWearable(new Hakama(GetRandomHue())); break;
                        }
                        case 1:
                        {
                            SetWearable(new TattsukeHakama(GetRandomHue())); break;
                        }
                    }
                }
                switch (Utility.Random(2))
                {
                    case 0:
                    {
                        SetWearable(new Sandals(GetShoeHue())); break;
                    }
                    case 1:
                    {
                        SetWearable(new Waraji(GetShoeHue())); break;
                    }
                }
            }
            else
            {
                switch (Utility.Random(3))
                {
                    case 0:
                    {
                        SetWearable(new FancyShirt(GetRandomHue())); break;
                    }
                    case 1:
                    {
                    ...
                    case 2:
                    {
                        SetWearable(new Shirt(GetRandomHue())); break;
                    }
                }
                ...
                switch (Utility.Random(4))
                {
                    case 0:
                    {
                        SetWearable(new Shoes(GetShoeHue())); break;
                    }
                    case 1:
                    {
                        SetWearable(new Boots(GetShoeHue())); break;
                    }
                    case 2:
                    {
                        SetWearable(new Sandals(GetShoeHue())); break;
                    ...
                    case 3:
                    {
                        SetWearable(new ThighBoots(GetShoeHue())); break;
                    }
                }
                ...
                if (Female)
                {
                    switch (Utility.Random(6))
                    {
                        case 0:
                        {
                            SetWearable(new ShortPants(GetRandomHue())); break;
                        }
                        case 1:
                        case 2:
                        {
                            SetWearable(new Kilt(GetRandomHue())); break;
                        }
                        case 3:
                        case 4:
                        case 5:
                        {
                            SetWearable(new Skirt(GetRandomHue())); break;
                        }
                    }
                }
                else
                {
                    switch (Utility.Random(2))
                    {
                        case 0:
                        {
                            SetWearable(new LongPants(GetRandomHue())); break;
                        }
                        case 1:
                        {
                            SetWearable(new ShortPants(GetRandomHue())); break;
            ...
            public override void OnClick()
            {
                if (m_Pilot != null && m_Pilot.Galleon != null)
                {
                    m_From.SendGump(new BasicConfirmGump<BaseGalleon>(new TextDefinition(1116618), (m, boat) => // Are you sure you wish to clear your ship's access list?
                    {
                        ...
                        foreach (Mobile x in boat.SecurityEntry.Manifest.Keys)
                        {
                            if (!boat.IsOwner(x))
                            {
                                list.Add(x);
