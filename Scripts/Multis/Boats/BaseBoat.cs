    ...
    public abstract class BaseBoat : BaseMulti, IMount
    {
        ...
        */
                ...
                for (int i = 0; i < e.Keywords.Length; ++i)
                {
                    ...
                    if (keyword >= 0x42 && keyword <= 0x6B || keyword == 0xF)
                    {
                        switch (keyword)
                        {
                            ...
                            case 0x43:
                            {
                                RemoveName(e.Mobile); break;
                            }
                            case 0x44:
                            {
                                GiveName(e.Mobile); break;
                            }
                            case 0x45:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Forward, true); break;
                            }
                            case 0x46:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Backward, true); break;
                            }
                            case 0x47:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Left, true); break;
                            }
                            case 0x48:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Right, true); break;
                            }
                            case 0x4B:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(ForwardLeft, true); break;
                            }
                            case 0x4C:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(ForwardRight, true); break;
                            }
                            case 0x4D:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(BackwardLeft, true); break;
                            }
                            case 0x4E:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(BackwardRight, true); break;
                            }
                            case 0x4F:
                            {
                                Order = BoatOrder.PlayerControlled; StopMove(true); break;
                            }
                            case 0x50:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Left, false); break;
                            }
                            case 0x51:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Right, false); break;
                            }
                            case 0x52:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Forward, false); break;
                            }
                            case 0x53:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Backward, false); break;
                            }
                            case 0x54:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(ForwardLeft, false); break;
                            }
                            case 0x55:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(ForwardRight, false); break;
                            }
                            case 0x56:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(BackwardRight, false); break;
                            }
                            case 0x57:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(BackwardLeft, false); break;
                            }
                            case 0x58:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(Left); break;
                            }
                            case 0x59:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(Right); break;
                            }
                            case 0x5A:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(Forward); break;
                            }
                            case 0x5B:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(Backward); break;
                            }
                            case 0x5C:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(ForwardLeft); break;
                            }
                            case 0x5D:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(ForwardRight); break;
                            }
                            case 0x5E:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(BackwardRight); break;
                            }
                            case 0x5F:
                            {
                                Order = BoatOrder.PlayerControlled; OneMove(BackwardLeft); break;
                            }
                            case 0x49:
                            case 0x65:
                            {
                                Order = BoatOrder.PlayerControlled; StartTurn(2, true); break; // turn right
                            }
                            case 0x4A:
                            case 0x66:
                            {
                                Order = BoatOrder.PlayerControlled; StartTurn(-2, true); break; // turn left
                            }
                            case 0x67:
                            {
                                Order = BoatOrder.PlayerControlled; StartTurn(-4, true); break; // turn around, come about
                            }
                            case 0x68:
                            {
                                Order = BoatOrder.PlayerControlled; StartMove(Forward, true); break;
                            ...
                            case 0x60:
                            {
                                GiveNavPoint(); break; // nav
                            }
                            case 0x61:
                            {
                                NextNavPoint = 0; StartCourse(false, true); break; // start
                            }
                            case 0x62:
                            {
                                StartCourse(false, true); break; // continue
                            }
                            case 0x63:
                            {
                                StartCourse(e.Speech, false, true); break; // goto*
                            }
                            case 0x64:
                            {
                                StartCourse(e.Speech, true, true); break; // single*
                            }
                            case 0xF:
                            {
                                TryTrack(from, e.Speech); break;
                            }
                        }
        ...
        public virtual bool SetFacing(Direction facing)
        {
            ...
            for (int index = 0; index < toMove.Count; index++)
            {
        ...
        public virtual TimeSpan GetMovementInterval(int speed, out int clientSpeed)
        {
            switch (speed)
            {
                default:
                {
                    clientSpeed = 0x0; return TimeSpan.Zero;
                }
                case 1:
                {
                    clientSpeed = 0x2; return SlowInt;
                }
                case 2:
                {
                    clientSpeed = 0x4; return FastInt;
                }
            }
        }
