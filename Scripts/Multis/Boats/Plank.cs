        ...
        public void SetFacing(Direction dir)
        {
            if (IsOpen)
            {
                switch (dir)
                {
                    ...
                    {
                        ItemID = Starboard ? 0x3ED4 : 0x3ED5; break;
                    }
                    case Direction.East:
                    {
                        ItemID = Starboard ? 0x3E84 : 0x3E89; break;
                    }
                    case Direction.South:
                    {
                        ItemID = Starboard ? 0x3ED5 : 0x3ED4; break;
                    }
                    case Direction.West:
                    {
                        ItemID = Starboard ? 0x3E89 : 0x3E84; break;
                    }
                }
            }
            else
            {
                switch (dir)
                {
                    case Direction.North:
                    {
                        ItemID = Starboard ? 0x3EB2 : 0x3EB1; break;
                    }
                    case Direction.East:
                    {
                        ItemID = Starboard ? 0x3E85 : 0x3E8A; break;
                    }
                    case Direction.South:
                    {
                        ItemID = Starboard ? 0x3EB1 : 0x3EB2; break;
                    }
                    case Direction.West:
                    {
                        ItemID = Starboard ? 0x3E8A : 0x3E85; break;
                    }
                }
            }
        }
